...
-For this challenge, we are given 3 challenges to tackle, that are majorly backboned by Python Language.
...
- A laptop, Ipod, Tablet or Smart-Phone.
- Constant Power Supply.

# Languages Used
- For this Compulsory challenge, we are expected to only use one Programming Language:
--> Python